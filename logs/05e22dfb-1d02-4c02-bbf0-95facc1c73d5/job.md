...
Use the SEND_LEASE.md instructions and render the appropriate lease template with all the correct details from the Excel data, including the $1,800 security deposit, but override the email destination for testing.